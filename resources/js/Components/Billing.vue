<template>
    <div class="flex flex-col text-center w-full mt-12">
        <h1 class="text-3xl font-bold title-font text-gray-900">Billing History
        </h1>
        <p class="font-light">See the list of your payments and manage your subscriptions</p>
    </div>
    <section v-if="this.billing" class="container px-4 mx-auto sm:mt-12">
    ...
    <div v-else class="flex flex-col text-center w-full mt-12">
        <h1 class="text-2xl font-bold title-font text-gray-300 border-2 mx-16 py-20 rounded-lg">You don't have any payment
            history.
        </h1>
    </div>
</template>
